...
public class MainActivity extends AppCompatActivity {
   ...
   ExpandableListAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new com.example.myapplication.adapter.ExpandableListAdapter(this,listDataHeader,listDataChild);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        seminar.setTitle(seminarObject.getString("name").toString());
                        seminar.setCoverImage(seminarObject.getString("cover"));
